...
exports.prismaFolderCreatorController = void 0;
...
const prisma_creator_service_1 = require("./prisma.creator.service");
const createPrismaModules = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const archive = yield prisma_creator_service_1.prismaFolderCreatorService.createPrismaTemplate({
        name,
        modules,
    });
    yield creation_service_1.CreationService.addCreation({
        ...
        technology: common_1.ITechnology.PostgresModule,
    });
...
const createPrismaTemplate = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield creation_service_1.CreationService.addCreation({
        ...
        language: common_1.ILanguage.Typescript,
        technology: common_1.ITechnology.PostgresTemplate,
    });
    // Set headers to trigger the download
    res.setHeader('Content-Disposition', `attachment; filename="${name}.zip"`);
    res.setHeader('Content-Type', 'application/octet-stream');
...
exports.prismaFolderCreatorController = {
